...
import com.lovushkina.dto.assembler.CreaterDtoAssembler;
...
public class CreaterController {
    ...
    public ResponseEntity<?> addManyToManyRelationShip(@RequestBody JSONObject jsonObject) {
        createrService.addManyToManyRelationShip(jsonObject.getAsString("app_name"), jsonObject.getAsString("creater_full_name"));
        return new ResponseEntity<>(HttpStatus.OK);
    }
