...
import com.lovushkina.dto.CategoryDto;
import com.lovushkina.dto.assembler.AppDtoAssembler;
import com.lovushkina.dto.assembler.CategoryDtoAssembler;
...
public class CategoryController {
    ...
    public ResponseEntity<CollectionModel<AppDto>> getPlaylistsById(@PathVariable Integer id){
        return new ResponseEntity<>(appDtoAssembler.toCollectionModel(categoryService.findById(id).getApps()), HttpStatus.OK);
    }
